.data
intro1: .string "bin/intro1.bin"
main1: .string "bin/main1.bin"
main2: .string "bin/main2.bin"
main3: .string "bin/main3.bin"
main4: .string "bin/main4.bin" 
instrucoes1: .string "bin/instrucoes1.bin"
instrucoes2: .string "bin/instrucoes2.bin" 
creditos1: .string "bin/credito1.bin" 
gameover1: .string "bin/gameover1.bin"
gameover2: .string "bin/gameover2.bin"
...
#####################
# Transition scene
NEXT_STAGE_FILE: .string "bin/nextstage.bin"
BACKGROUND_NEXT_STAGE1_FILE: .string "bin/transicao_fase1.bin"
BACKGROUND_NEXT_STAGE2_FILE: .string "bin/transicao_fase2.bin"
BACKGROUND_NEXT_STAGE3_FILE: .string "bin/transicao_fase3.bin"
BACKGROUND_NEXT_STAGE4_FILE: .string "bin/transicao_fase4.bin"
SCENE_TRANSITION: .space 7808
#####################
# Death scene
DEATH_MSPACMAN_FILE: .string "bin/MsPacmanDeath.bin"
DEATH_MSPACMAN: .space 1024
#####################
# Background map
BACKGROUND_MAP: .string "bin/background_map.bin"
#####################
# Mecanics
...
#####################
# MAPA 1
map1.image_file: .string "bin/Mapa1.bin"
map1.frame_file: .string "bin/map1frame.bin"
cherry_file: .string "bin/cherry.bin"
strawberry_file: .string "bin/strawberry.bin"
map1fruit_path_file: .string "bin/map1fruit_path.bin"
####################

#####################
# MAPA 2
map2.image_file: .string "bin/Mapa2.bin"
map2.frame_file: .string "bin/map2frame.bin"
orange_file:  .string "bin/orange.bin" 
pretzel_file: .string "bin/pretzel.bin"
map2fruit_path_file: .string "bin/map2fruit_path.bin"
####################

#####################
# MAPA 3
map3.image_file: .string "bin/Mapa3.bin"
map3.frame_file: .string "bin/map3frame.bin"
apple_file:  .string "bin/apple.bin" 
pear_file: .string "bin/pear.bin"
map3fruit_path_file: .string "bin/map3fruit_path.bin"
####################

#####################
# MAPA 4
map4.image_file: .string "bin/Mapa4.bin"
map4.frame_file: .string "bin/map4frame.bin"
banana_file:  .string "bin/banana.bin" 
key_file: .string "bin/key.bin"
map4fruit_path_file: .string "bin/map4fruit_path.bin"
####################
# Animation algorythm
...
#{
	...
	mspac.image_file: .string "bin/MsPacman.bin"
	# "MsPacman1.bin"
...
#{
	...
	blinky.image_file: .string "bin/Blinky.bin"
	...
	blinky.enter_home_file: .string "bin/blinky_enter.bin"
	.align 2
	blinky.enter_home: .space 48
	blinky.exit_home_file: .string "bin/blinky_exit.bin"
	.align 2
...
#{
	...
	pinky.image_file: .string "bin/Pinky.bin"
	...
	pinky.enter_home_file: .string "bin/pinky_enter.bin"
	.align 2
	pinky.enter_home: .space 48
	pinky.exit_home_file: .string "bin/pinky_exit.bin"
	.align 2
...
#{
	...
	inky.image_file: .string "bin/Inky.bin"
	inky.image: .space 10368
	.align 1
	inky.status: .space 3
	# 0000 0001 = chase, 0000 0010 = scatter, 0000 0100 = blue, 0000 1000 = white,  0001 0000 = eye, 0010 0000 = exit, 0100 0000 = enter, 1000 0000 = slow (bordas do mapa) 
	inky.enter_home_file: .string "bin/inky_enter.bin"
	.align 2
	inky.enter_home: .space 80
	inky.exit_home_file: .string "bin/inky_exit.bin"
	.align 2
...
#{
	...
	clyde.image_file: .string "bin/Clyde.bin"
	clyde.image: .space 10368
	.align 1
	clyde.status: .space 3
	# 0000 0001 = chase, 0000 0010 = scatter, 0000 0100 = blue, 0000 1000 = white,  0001 0000 = eye, 0010 0000 = exit, 0100 0000 = enter, 1000 0000 = slow (bordas do mapa) 
	clyde.enter_home_file: .string "bin/clyde_enter.bin"
	.align 2
	clyde.enter_home: .space 80
	clyde.exit_home_file: .string "bin/clyde_exit.bin"
	.align 2
	clyde.exit_home: .space 168
	clyde.script_counter: .half 0
#}
### BLUE GHOST
blue.image_file: .string "bin/blue_ghost.bin"
blue.image: .space 648
blue.image_pointer: .word 0
white.image_file: .string "bin/almost_blue_ghost.bin"
white.image: .space 1296
white.image_pointer: .word 0
eye.image_file: .string "bin/dead_ghost.bin"
